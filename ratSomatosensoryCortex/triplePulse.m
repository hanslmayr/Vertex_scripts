...
TissueParams.StimulationOn = [500 650 800 950]; 
TissueParams.StimulationOff = TissueParams.StimulationOn + 0.5;
...
RecordingSettings.saveDir = ['I:\WT_resub\Vertex_simulations\F1000_Data\pairedpulse\quadrpulse_' num2str(SimulationSettings.randomSeed)];
